...
6. Если информация неизвестна — просто не включай поле. Никогда не пиши "не указано", "нет данных", "unknown", "@username", "username" и т.п.
...
Ищи по ВСЕМ полям: data, comment, raw, tags, category.
Правила поиска:
- Частичное совпадение: "AI" находит "AI-креатор", "artificial intelligence"
- Аббревиатуры и сокращения: "ии" = "искусственный интеллект" = "AI"
- Синонимы и смысловая близость: "нейросеть" = "AI" = "машинное обучение"
- Латиница/кириллица взаимозаменяемы для аббревиатур
- Ищи даже если совпадение неточное — лучше лишний результат, чем пропустить нужный
